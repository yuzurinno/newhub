        ...
        <div class="main-container">
            ...
            <div class="content-wrapper">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="edit-profile-tab" data-toggle="tab" href="#eedit-profile-tab" role="tab" aria-controls="edit-profile-tab" aria-selected="false">Edit Profile</a>
                    </li>
                </ul>
                <div class="col-lg-12">
                    <div class="tab-content mt-4" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="edit-profile-tab" role="tabpanel" aria-labelledby="edit-profile-tab">
                        <label for="px_code" class="col-form-label" style="font-size: 13px;"><b>Edit Client Profile:</b></label>
                            <form method="post" action="" id="form_submit">
                                <div class="card">
                                    <div class="card-header" style="font-size: 16px"><b>arfBasic Information</b></div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
