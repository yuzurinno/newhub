...
CREATE TABLE `regimen` (
  `id` int(11) NOT NULL,
  `regimen_name` varchar(30) NOT NULL,
  `pills_per_day` int(2) NOT NULL,
  `critical_level` int(2) DEFAULT NULL,
...
INSERT INTO `regimen` VALUES (1,'name',0,NULL,NULL),(2,'sample',0,NULL,NULL);
